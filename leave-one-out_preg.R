...
setwd("/PROJECTES/INMA_OMICS/analyses/PACE/green_spaces_SA/results/MA/leave-one-out/leave-one-out_preg/")
...
prefixes <- c('ALSPAC_M3_NDVI300','EDEN_M3_NDVI300','ENV.450K_M3_NDVI300','ENV.EPIC_M3_NDVI300','GenR_M3_NDVI300','INMA_M3_NDVI300','PFC_M3_NDVI300','ALSPAC_M3_NDVI100',
              'EDEN_M3_NDVI100','ENV.450K_M3_NDVI100','ENV.EPIC_M3_NDVI100','GenR_M3_NDVI100','INMA_M3_NDVI100','PFC_M3_NDVI100','ALSPAC_M3_AcGS','EDEN_M3_AcGS','GenR_M3_AcGS','INMA_M3_AcGS','PFC_M3_AcGS')
# Samples in original files used in QC

N<-c(618,137,188,345,1171,357,172,618,137,188,345,1171,357,172,618,95,1171,357,172)

# Define data for each meta-analysis
 metafiles <- list(
   'Leave-one-M3_NDVI300_exc_ALSPAC' = c('EDEN_M3_NDVI300','ENV.450K_M3_NDVI300','ENV.EPIC_M3_NDVI300','GenR_M3_NDVI300','INMA_M3_NDVI300','PFC_M3_NDVI300'),
    'Leave-one-M3_NDVI300_exc_EDEN' = c('ALSPAC_M3_NDVI300','ENV.450K_M3_NDVI300','ENV.EPIC_M3_NDVI300','GenR_M3_NDVI300','INMA_M3_NDVI300','PFC_M3_NDVI300'),
    'Leave-one-M3_NDVI300_exc_ENV.450K' = c('ALSPAC_M3_NDVI300','EDEN_M3_NDVI300','ENV.EPIC_M3_NDVI300','GenR_M3_NDVI300','INMA_M3_NDVI300','PFC_M3_NDVI300'),
    'Leave-one-M3_NDVI300_exc_ENV.EPIC' = c('ALSPAC_M3_NDVI300','EDEN_M3_NDVI300','ENV.450K_M3_NDVI300','GenR_M3_NDVI300','INMA_M3_NDVI300','PFC_M3_NDVI300'),
    'Leave-one-M3_NDVI300_exc_GenR' = c('ALSPAC_M3_NDVI300','EDEN_M3_NDVI300','ENV.450K_M3_NDVI300','ENV.EPIC_M3_NDVI300','INMA_M3_NDVI300','PFC_M3_NDVI300'),
    'Leave-one-M3_NDVI300_exc_INMA' = c('ALSPAC_M3_NDVI300','EDEN_M3_NDVI300','ENV.450K_M3_NDVI300','ENV.EPIC_M3_NDVI300','GenR_M3_NDVI300','PFC_M3_NDVI300'),
    'Leave-one-M3_NDVI300_exc_PFC' = c('ALSPAC_M3_NDVI300','EDEN_M3_NDVI300','ENV.450K_M3_NDVI300','ENV.EPIC_M3_NDVI300','GenR_M3_NDVI300','INMA_M3_NDVI300'),
    'Leave-one-M3_NDVI100_exc_ALSPAC' = c('EDEN_M3_NDVI100','ENV.450K_M3_NDVI100','ENV.EPIC_M3_NDVI100','GenR_M3_NDVI100','INMA_M3_NDVI100','PFC_M3_NDVI100'),
    'Leave-one-M3_NDVI100_exc_EDEN' = c('ALSPAC_M3_NDVI100','ENV.450K_M3_NDVI100','ENV.EPIC_M3_NDVI100','GenR_M3_NDVI100','INMA_M3_NDVI100','PFC_M3_NDVI100'),
    'Leave-one-M3_NDVI100_exc_ENV.450K' = c('ALSPAC_M3_NDVI100','EDEN_M3_NDVI100','ENV.EPIC_M3_NDVI100','GenR_M3_NDVI100','INMA_M3_NDVI100','PFC_M3_NDVI100'),
    'Leave-one-M3_NDVI100_exc_ENV.EPIC' = c('ALSPAC_M3_NDVI100','EDEN_M3_NDVI100','ENV.450K_M3_NDVI100','GenR_M3_NDVI100','INMA_M3_NDVI100','PFC_M3_NDVI100'),
    'Leave-one-M3_NDVI100_exc_GenR' = c('ALSPAC_M3_NDVI100','EDEN_M3_NDVI100','ENV.450K_M3_NDVI100','ENV.EPIC_M3_NDVI100','INMA_M3_NDVI100','PFC_M3_NDVI100'),
    'Leave-one-M3_NDVI100_exc_INMA' = c('ALSPAC_M3_NDVI100','EDEN_M3_NDVI100','ENV.450K_M3_NDVI100','ENV.EPIC_M3_NDVI100','GenR_M3_NDVI100','PFC_M3_NDVI100'),
    'Leave-one-M3_NDVI100_exc_PFC' = c('ALSPAC_M3_NDVI100','EDEN_M3_NDVI100','ENV.450K_M3_NDVI100','ENV.EPIC_M3_NDVI100','GenR_M3_NDVI100','INMA_M3_NDVI100'),
    'Leave-one-M3_AcGS_exc_ALSPAC' = c('GenR_M3_AcGS','INMA_M3_AcGS','PFC_M3_AcGS'),
    'Leave-one-M3_AcGS_exc_GenR' = c('ALSPAC_M3_AcGS','INMA_M3_AcGS','PFC_M3_AcGS'),
    'Leave-one-M3_AcGS_exc_INMA' = c('ALSPAC_M3_AcGS','GenR_M3_AcGS','PFC_M3_AcGS'),
    'Leave-one-M3_AcGS_exc_PFC' = c('ALSPAC_M3_AcGS','GenR_M3_AcGS','INMA_M3_AcGS'))


# Array type, used in each meta-analysis : EPIC or 450K
artype <- c('450K','450K','450K','450K','450K','450K','450K','450K','450K','450K','450K','450K','450K','450K','450K','450K','450K','450K','450K','450K')
...
venn_diagrams <- list(c( 'Leave-one-M3_AcGS_exc_ALSPAC','Leave-one-M3_AcGS_exc_GenR'))
