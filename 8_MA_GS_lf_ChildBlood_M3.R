#############################################################
# META-ANALYSIS M3 Green Spaces Life-long - child blood
#14.04.2023
...
metafiles <- list(
   'MetaM3_NDVI300_lf' = c('ALSPAC_M3_NDVI300_lf','GenR_M3_NDVI300_lf','HELIX_M3_NDVI300_lf'),
   'MetaM3_NDVI100_lf' = c('ALSPAC_M3_NDVI100_lf','GenR_M3_NDVI100_lf','HELIX_M3_NDVI100_lf')
   )
...
venn_diagrams <- list(c("MetaM3_NDVI300_lf","MetaM3_NDVI100_lf"))
